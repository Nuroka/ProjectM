...
AKartRaceSportsCar::AKartRaceSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UKartRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UKartRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UKartRaceSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UKartRaceSportsWheelRear::StaticClass();
