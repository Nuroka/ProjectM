...
#include "KartRacePlayerController.generated.h"
 ...
 */
UCLASS(abstract)
class KARTRACE_API AKartRacePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AKartRacePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UKartRaceUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UKartRaceUI> VehicleUI;
